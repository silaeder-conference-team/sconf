    ...
    return (
        <Container size={419} my={40}>
            ...
            <Text color="dimmed" size="sm" align="center" mt={5}>
                Если вы уже использовали платформу то войдите в свой аккаунт, в противном случае создайте его и пройдите по ссылке "У меня нет аккаунта".
                Если в вашем имени, фамилии или отчестве есть буква "ё", замените, её, пожалуйста на "е".
            </Text>
